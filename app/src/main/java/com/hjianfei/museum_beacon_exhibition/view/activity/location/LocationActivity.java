...
public class LocationActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    LetterListView letter_list_view;// A-Z listview
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        letter_list_view.setOnTouchingLetterChangedListener(new LetterListViewListener());
        ...
        city_list_view.setOnScrollListener(this);
        resultListAdapter = new ResultListAdapter(this, city_result);
        search_result.setAdapter(resultListAdapter);
    ...
    public void InsertCity(String name) {
        ...
        Cursor cursor = db.rawQuery("select * from recent_city where name = '"
                + name + "'", null);
        if (cursor.getCount() > 0) { //
            db.delete("recent_city", "name = ?", new String[]{name});
        }
        db.execSQL("insert into recent_city(name, date) values('" + name + "', "
...
//        option.setPoiNumber(3);
    ...
    private void hisCityInit() {
        ...
        Cursor cursor = db.rawQuery(
                "select * from recent_city order by date desc limit 0, 3", null);
    ...
    private class LetterListViewListener implements LetterListView.OnTouchingLetterChangedListener {
        ...
        public void onTouchingLetterChanged(final String s) {
            ...
            if (alphaIndexer.get(s) != null) {
                ...
                city_list_view.setSelection(position);
                overlay.setText(s);
